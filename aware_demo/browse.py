...
import requests
import json
url='https://api.at.top/v1/articles/25707538628487716'
url1='https://api.at.top/v1/articles/25707426170808868'
url2='https://api.at.top/v1/articles/24951836767169060'
header={
...
if __name__ == '__main__':
    for i in range(300):
        # send_get(url,header)
        # send_get(url1,header)
        send_get(url2,header)
